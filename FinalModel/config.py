...
parser.add_argument('--num_classes1', type = int, default  = 10, help = 'number of classes')
parser.add_argument('--num_classes2', type = int, default  = 15, help = 'number of classes')
parser.add_argument('--num_classes3', type = int, default  = 20, help = 'number of classes')
