...
class SparseResNet(object):
    def __init__(self, config, is_training = False):
        ...
        lv1 = self.fc(lv1, self.num_classes1, 'fc-lv1')
        lv2 = self.fc(lv2, self.num_classes2 - self.num_classes1, 'fc-lv2')
        lv3 = self.fc(lv3, self.num_classes3 - self.num_classes2, 'fc-lv3')

        y1 = lv1
        y2 = tf.concat([lv1, lv2], 1)
        y3 = tf.concat([lv1, lv2, lv3], 1)
