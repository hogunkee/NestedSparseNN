...
class SparseResNet(object):
    def __init__(self, config, is_training = False):
        ...
        self.Y1 = Y1 = tf.placeholder(tf.float32, shape = [None, self.num_classes1], name = 'Y1_placeholder')
        self.Y2 = Y2 = tf.placeholder(tf.float32, shape = [None, self.num_classes2 - self.num_classes1], name = 'Y2_placeholder')
        self.Y3 = Y3 = tf.placeholder(tf.float32, shape = [None, self.num_classes3 - self.num_classes2], name = 'Y3_placeholder')
        ...
        y1 = self.fc(lv1, self.num_classes1, 'fc-lv1')
        y2 = self.fc(lv2, self.num_classes2 - self.num_classes1, 'fc-lv2')
        y3 = self.fc(lv3, self.num_classes3 - self.num_classes2, 'fc-lv3')
