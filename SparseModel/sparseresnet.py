...
class SparseResNet(object):
    def __init__(self, config, is_training = False):
        ...
        self.Y2 = Y2 = tf.placeholder(tf.float32, shape = [None, self.num_classes2 - self.num_classes], name = 'Y2_placeholder')
        ...
        y2 = self.fc(lv2, self.num_classes2 - self.num_classes, 'fc-lv2')
