...
parser.add_argument('--num_classes2', type = int, default  = 12, help = 'number of classes')
parser.add_argument('--learning_rate', type = float, default = 0.0001, help = 'learning rate')
parser.add_argument('--learning_rate2', type = float, default = 0.0001, help = 'learning rate')
