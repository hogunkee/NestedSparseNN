...
parser.add_argument('--version', type = int, default = 2, help = 'vgg version (1 or 2)')
...
parser.add_argument('--padding', type = bool, default = True, help = 'crop and padding')
parser.add_argument('--norm', type = bool, default = True, help = 'image pixel normalize')
